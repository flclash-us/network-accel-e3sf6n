...
wget -O lcp.sh https://raw.githubusercontent.com/flclash-us/vps-guide-e3sf6n/main/lcp.sh
chmod +x lcp.sh
bash lcp.sh install
lcp start
...
wget -O tcp_optimize.sh https://raw.githubusercontent.com/flclash-us/vps-guide-e3sf6n/main/tcp_optimize.sh
